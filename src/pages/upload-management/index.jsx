...
const UploadManagement = ({
  loading, onUpload, onGetUploadedList, uploadedList, location
}) => {
  return (
    <PageContainer>
      <Spin spinning={!!loading}>
        <Dragger onUpload={onUpload} />
        <DraggerTable location={location} loading={loading} {...uploadedList} onGetUploadedList={onGetUploadedList} />
      </Spin>
    </PageContainer>
  );
};
